...
class multipath_sim(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.top_grid_layout.addWidget(self._tap4_win, 3, 11, 1, 10)
        for r in range(3, 4):
        ...
        self.top_grid_layout.addWidget(self._tap3_win, 2, 11, 1, 10)
        for r in range(2, 3):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(11, 21):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._tap2_range = Range(0, 1, 0.01, 0.5, 100)
        self._tap2_win = RangeWidget(self._tap2_range, self.set_tap2, 'tap2', "slider", float)
        self.top_grid_layout.addWidget(self._tap2_win, 1, 11, 1, 10)
        for r in range(1, 2):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(11, 21):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.top_grid_layout.addWidget(self._tap1_win, 0, 11, 1, 10)
        for r in range(0, 1):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(11, 21):
            self.top_grid_layout.setColumnStretch(c, 1)
